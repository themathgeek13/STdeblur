...
listing2 = os.listdir('handclapping')

for vid2 in listing2:
    vid2 = 'handclapping/'+vid2
    frames = []
...
listing3 = os.listdir('handwaving')

for vid3 in listing3:
    vid3 = 'handwaving/'+vid3
    frames = []
